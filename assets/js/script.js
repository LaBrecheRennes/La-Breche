        ...
        container.innerHTML = `
            <div class="col-span-full text-center py-10 px-6 bg-gradient-to-br from-purple-50 to-blue-50 border border-purple-200 rounded-2xl shadow-sm max-w-xl mx-auto">
                ...
                <div class="flex flex-col sm:flex-row gap-3 justify-center items-center">
                    <a href="https://www.instagram.com/collectif.labreche/" target="_blank" rel="noopener noreferrer" 
                    ...
                    <a href="https://www.instagram.com/cridev35/" target="_blank" rel="noopener noreferrer" 
